...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='crowdhuman_yolov5m.pt', help='initial weights path')
    ...
    parser.add_argument('--name', default='customtest', help='save to project/name')
